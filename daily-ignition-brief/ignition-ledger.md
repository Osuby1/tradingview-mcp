...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-06-20 | SNDK | A | 1,914.46 (6/24 ref) | — | — | 1,815.78 (7/6 AM) | −5.2% | FADING | pending | System archetype (~40x from $36). Flagged extended (RVOL 0.6, no fresh fire). Semis unwound 7/1–7/2 (SMH Chandelier SELL flip); 7/2 bar traded 2,052→1,693 intraday. Bounced +4% in the 7/6 group gap-up (SK Hynix US listing + INTC price hikes); SMH Chandelier still SELL (flip 651.30). |
...
| 2026-07-06 | AXON | SKIP @ 618.88 | 618.88 | — | — | 618.88 (7/6) | 0% | WATCH | pending | Deliberate skip at the 620 alert: +51% in 12 sessions, 41% above 50-day mean, RVOL 0.39 on the 620 cross (light-volume breakout), RSbeat 0, no fresh EI/Lift-Off flag, Chandelier stop 15% below (526). Trump-buy + ICE $220M *solicitation* headline froth on real fundamentals (rev +34%, AI +700%, bookings $14.3B). Plan: buy the pullback ~560–580, NOT the chase. If it runs to 700+ without us: 😤 MISSED verdict and study why. |
| 2026-07-01 | HOPE | B+ starter | 13.95 (7/2 entry ref) | — | — | 13.58 (7/2) | −2.7% | WATCH | pending | EI IGNITE fired 7/1 (+18% >200SMA, ADX 27, RSbeat 1) but at/above analyst PT cluster. Omar round-tripped 700sh 13.95→13.75 (−$140, flat-into-holiday rule, not setup failure). Re-entry alerts NOT re-wired. **Earnings Tue 7/21 — no full size into print.** |
