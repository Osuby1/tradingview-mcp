...
readme_sheet(
    ...
    key_readings=[
        ...
        ("Readiness 0-100", "Poised-to-move score. The gates answer 'is it SAFE to buy'; "
                            "this answers 'is a move LOADING soon, in the trade's "
                            "direction'. Five classic ready-to-run checks, 20 points "
                            "each: (1) SQUEEZE - price bands coiled to their tightest in "
                            "months = energy stored, the closest thing to a true 'ready' "
                            "signal; (2) TRIGGER - how close price sits to its 20-day "
                            "high, i.e. how short the fuse is (one good day vs a long "
                            "grind); (3) VOLUME - quiet accumulation: big money sneaking "
                            "in while price goes sideways; (4) MOMENTUM - the turn "
                            "before the turn: momentum just changed direction toward the "
                            "trade; (5) RELATIVE STRENGTH - beating the market at a "
                            "60-day extreme, money singling this name out right now. The "
                            "text after the number names the lit and dead ingredients - "
                            "READ THE TEXT, not just the number: a 54 built on 'tight "
                            "coil + volume' is a different animal from a 54 built on "
                            "'strong but bands blown out'. 'n/a' = the overnight scoring "
                            "step did not run for that name."),
        ("Readiness - the levels", "UNDER ~30 = RESTING: energy already spent (bands wide "
                            "after a move) or nothing loading - expect sideways unless "
                            "news does the work; a fine HOLDING can score here (DGX read "
                            "26 and beat the market that week while going nowhere vs its "
                            "entry). 40-60 = MIXED: two or three parts lit - the driver "
                            "text decides whether it's interesting. 70+ = RARE/COILED: "
                            "most parts firing together; CORT hit 95 on 7/7 and ran +22%. "
                            "PRIME SETUP tag (options tab) = tight squeeze + cheap "
                            "premium at once - the one pattern with real published "
                            "history. NOW THE HONEST PART (first calibration look, "
                            "2026-08-01): comparing the big skipped runners vs skipped "
                            "picks that went NOWHERE, pick-day scores showed NO "
                            "separation (means 47 vs 43) - PSA scored 80 and never moved "
                            "2%; CAKE scored 16 and ran +30% on earnings. The score sees "
                            "STORED ENERGY only - it is blind to catalyst movers (news, "
                            "earnings gaps) and says nothing about direction or exact "
                            "timing. So it works BOTH ways: a high score is NOT a green "
                            "light and a low score is NOT a veto. Use it to decide which "
                            "gate-passer to LOOK AT first and what posture you're "
                            "buying (coiled vs resting), never as the reason to trade. "
                            "The nightly scan is collecting the forward evidence; Friday "
                            "reviews decide if any threshold ever earns real power."),
